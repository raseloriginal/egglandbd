...
<header class="agent-header">
  ...
  <div class="hdr-title"><div class="hdr-name">My Ledger</div><div class="hdr-sub">Transaction History</div></div>
  <div class="hdr-avatar" onclick="history.back()"><i class="fas fa-arrow-left"></i></div>
</header>
<main class="agent-main">
  <div class="agent-blank">
    <div class="ab-icon"><i class="fas fa-book"></i></div>
    <h2>Ledger</h2>
    <p>Your transaction history, deposits<br>and balance details will appear here.</p>
    <div class="ab-badge">🚧 Coming in Next Phase</div>
  </div>
</main>
