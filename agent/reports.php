...
$sidebarNav = '
  ...
  <a href="/egglandbd/agent/reports.php" class="sidebar-link active"><i class="fas fa-chart-bar sidebar-icon"></i> Reports</a>
  ...
  <div class="toolbar" style="flex-wrap:wrap;gap:10px">
    <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
      ...
      <div id="reportTypeTabs" style="display:flex;gap:6px;flex-wrap:wrap">
        <?php foreach (['sales'=>'Sales','cashflow'=>'Cashflow','products'=>'Products'] as $k=>$v): ?>
...
<nav class="bottom-nav">
  <div class="bottom-nav-items">
    ...
    <a href="/egglandbd/agent/reports.php" class="bottom-nav-item active"><div class="bottom-nav-icon"><i class="fas fa-chart-bar"></i></div>Reports</a>
  </div>
</nav>
