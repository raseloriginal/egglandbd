...
$sidebarNav = '
  ...
  <a href="/egglandbd/sr/retailers.php" class="sidebar-link active"><i class="fas fa-store sidebar-icon"></i> Retailers</a>
';
...
<nav class="bottom-nav">
  <div class="bottom-nav-items">
    ...
    <a href="/egglandbd/sr/orders.php" class="bottom-nav-item"><div class="bottom-nav-icon"><i class="fas fa-list"></i></div>Orders</a>
    <a href="/egglandbd/sr/retailers.php" class="bottom-nav-item active"><div class="bottom-nav-icon"><i class="fas fa-store"></i></div>Retailers</a>
  </div>
</nav>
...
async function loadRetailers(page = 1) {
  ...
  if (!resp.data.length) {
    tbody.innerHTML = '<tr><td colspan="6"><div class="empty-state"><div class="empty-state-icon">🏪</div><div class="empty-state-title">No retailers found</div><div class="empty-state-sub"><a href="/egglandbd/sr/map.php" class="btn btn-primary btn-sm" style="margin-top:12px"><i class="fas fa-plus"></i> Add Retailer via Map</a></div></div></td></tr>';
    return;
  }
