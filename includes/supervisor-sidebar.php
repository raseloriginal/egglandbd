...
<aside class="sidebar" id="supSidebar" style="--sidebar-bg:#1A0A00;">
  ...
  <nav class="sidebar-nav">
    <div class="nav-section">
      ...
      <a href="/egglandbangladesh/supervisor/dashboard.php" class="nav-item <?= $currentPage === 'dashboard' ? 'active' : '' ?>" style="<?= $currentPage === 'dashboard' ? '--sidebar-active:#D4850A' : '' ?>">
        <span class="nav-icon"><i class="fas fa-chart-bar"></i></span> Dashboard
      </a>
    </div>
    <div class="nav-section">
      <div class="nav-section-label">Agent Management</div>
      <a href="/egglandbangladesh/supervisor/agents.php" class="nav-item <?= $currentPage === 'agents' ? 'active' : '' ?>">
        <span class="nav-icon"><i class="fas fa-users"></i></span> Agents
      </a>
      <a href="/egglandbangladesh/supervisor/agent-ledger.php" class="nav-item <?= $currentPage === 'agent-ledger' ? 'active' : '' ?>">
        <span class="nav-icon"><i class="fas fa-book"></i></span> Agent Ledger
      </a>
    </div>
    <div class="nav-section">
      <div class="nav-section-label">Operations</div>
      <a href="/egglandbangladesh/supervisor/sales.php" class="nav-item <?= $currentPage === 'sales' ? 'active' : '' ?>">
        <span class="nav-icon"><i class="fas fa-shopping-cart"></i></span> Sales <span class="nav-badge">Soon</span>
      </a>
      <a href="/egglandbangladesh/supervisor/demand.php" class="nav-item <?= $currentPage === 'demand' ? 'active' : '' ?>">
        <span class="nav-icon"><i class="fas fa-file-invoice-dollar"></i></span> Demand <span class="nav-badge">Soon</span>
      </a>
      <a href="/egglandbangladesh/supervisor/inventory.php" class="nav-item <?= $currentPage === 'inventory' ? 'active' : '' ?>">
